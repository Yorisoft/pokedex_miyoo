...
void Pokemon::setID(const int ID) { this->id = static_cast<unsigned short>(ID); }
unsigned short Pokemon::getID() const { return this->id; }

void Pokemon::setRegionalID(const int regional_id)
{
    this->regionalID = static_cast<unsigned short>(regional_id);
}
unsigned short Pokemon::getRegionalID() const { return this->regionalID; }

void Pokemon::setName(const std::string &name) { this->name = name; }
std::string Pokemon::getName() const { return this->name; }

void Pokemon::setGenus(const std::string &genus) { this->genus = genus; }
std::string Pokemon::getGenus() const { return this->genus; }
...
std::string Pokemon::getWeight() const { return this->weight; }
...
std::string Pokemon::getHeight() const { return this->height; }
...
std::vector<std::vector<std::string>> *Pokemon::getAbilities() const { return this->abilities; }
...
std::vector<double> *Pokemon::getGenderRates() const { return this->genderRates; }
...
std::string Pokemon::getFlavorText() const { return this->flavorText; }
...
void Pokemon::setHP(const unsigned short i) { this->healthPoint = i; }
unsigned short Pokemon::getHP() const { return this->healthPoint; }

// setter and getter for Attack
void Pokemon::setAttack(const unsigned short a) { this->attack = a; }
unsigned short Pokemon::getAttack() const { return this->attack; }

// setter and getter for Defense
void Pokemon::setDefense(const unsigned short d) { this->defense = d; }
unsigned short Pokemon::getDefense() const { return this->defense; }

// setter and getter for Special Attack
void Pokemon::setSpecialAttack(const unsigned short spa) { this->specialAttack = spa; }
unsigned short Pokemon::getSpecialAttack() const { return this->specialAttack; }

// setter and getter for Special Defense
void Pokemon::setSpecialDefense(const unsigned short spd) { this->specialDefense = spd; }
unsigned short Pokemon::getSpecialDefense() const { return this->specialDefense; }
...
unsigned short Pokemon::getSpeed() const { return this->speed; }

void Pokemon::setEvolutionChainID(const unsigned short ID) { this->evolutionChainID = ID; }
unsigned short Pokemon::getEvolutionChainID() const { return this->evolutionChainID; }
...
std::vector<std::vector<std::string>> *Pokemon::getEvolutionChain() const { return this->evoChain; }

void Pokemon::setEvolvesFromSpeciesID(const unsigned short ID) { this->evolvesFromSpeciesID = ID; }
unsigned short Pokemon::getEvolvesFromSpeciesID() const { return this->evolvesFromSpeciesID; }
...
std::vector<std::vector<std::string>> *Pokemon::getRoutes() const { return this->routes; }
