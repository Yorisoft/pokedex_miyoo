...
class PokedexActivity_PokemonView_Evolution : public PokedexActivity
{
  private:
    ...
    const std::string SOUND_LEFT_RIGHT_PATH = "res/assets/sound_effects/left_right.wav",
                      ...
                      ENTRY_BACKGROUND_IMAGE_PATH_DEFAULT =
                          "res/assets/misc/evolution_item_background_default.png",
                      ENTRY_BACKGROUND_IMAGE_PATH_SELECTED =
                          "res/assets/misc/evolution_item_background_selected.png",
    ...
    SDL_Surface *backgroundSurface, *listEntryBackground_default, *listEntryBackground_selected;
    SDL_Rect backgroundRect, listEntryRect, pokeRect, idRect, nameRect, methodRect, methodInfoRect;
