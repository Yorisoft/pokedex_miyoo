...
class PokedexActivity_PokemonView_Stats : public PokedexActivity
{
  private:
    ...
    const std::string FONT_PATH             = "res/assets/font/pokemon-dppt/pokemon-dppt.ttf",
    ...
    SDL_Surface *backgroundSurface, *pokeSprite, *pokeID, *pokeName, *abilitySurface,
        *h_abilitySurface;
    SDL_Rect backgroundRect, pokeSpriteRect, pokeIDRect, pokeNameRect, statsNameRect, statsRect,
