...
{
  private:
    std::string name, genus, weight, height, typeA, typeB, flavorText;
    unsigned short id, regionalID, healthPoint, attack, defense, specialAttack, specialDefense,
        speed, evolutionChainID, evolvesFromSpeciesID;
