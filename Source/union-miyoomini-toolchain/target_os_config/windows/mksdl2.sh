...
# Setup environment variables for cross-compilation from WSL2 to Windows
...
export CFLAGS="-Os -march=x86-64 -mtune=generic -ffunction-sections -fdata-sections -I/usr/x86_64-w64-mingw32/include"
export CXXFLAGS="-O3 -fPIC -pthread -I/usr/x86_64-w64-mingw32/include"
export LDFLAGS="-L/usr/x86_64-w64-mingw32/lib -static-libgcc -static-libstdc++"
